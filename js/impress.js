  ...
  var goto = function(event) {
        ...
        if (index >= 0) {
          ...
          if (isNumber(next)) {
            ...
            if (newTarget && newTarget.classList.contains('step')) {
              ...
              window.console.log(
                'impress goto plugin: ' + next + ' is not a step in this impress presentation.',
              );
            }
          }
        }
    ...
    if (data.gotoNext && event.detail.reason === 'next') {
      ...
      if (newTarget && newTarget.classList.contains('step')) {
        ...
        window.console.log(
          'impress goto plugin: ' + data.gotoNext + ' is not a step in this impress presentation.',
        );
      }
    }
    ...
    if (data.gotoPrev && event.detail.reason === 'prev') {
      ...
      if (newTarget && newTarget.classList.contains('step')) {
        ...
        window.console.log(
          'impress goto plugin: ' + data.gotoPrev + ' is not a step in this impress presentation.',
        );
      }
    }
    ...
    if (data.goto) {
      ...
      if (newTarget && newTarget.classList.contains('step')) {
        ...
        window.console.log(
          'impress goto plugin: ' + data.goto + ' is not a step in this impress presentation.',
        );
      }
    }
  };
...
(function(document, window) {
  ...
  document.addEventListener('impress:help:add', function(e) {
    ...
    rows[e.detail.row].push(
      '<tr><td><strong>' + e.detail.command + '</strong></td><td>' + e.detail.text + '</td></tr>',
    );
    renderHelpDiv();
  });
